...
return [
  ...
  */
  ...
  'reset_password_link_has_been_send' => 'A Reset password link has been send to your email',
  'invalid_token'                 => 'Invalid token or token doesn\'t exists',
  'reset_password_failed'         => 'Opss, we can not reset your password. Maybe you already did ? Otherwise please try reset password again.',
];
