                                        ...
                                        <div class="o_px-xs o_sans o_text o_left o_xs-center"
                                            ...
                                            <p
                                                style="
                                                        ...
                                                        margin-bottom: 0px;
                                                    ">
                                                <a class="o_text-primary" href="{{ env('APP_FRONT_END_URL') }}"
                                                    style="
                                                            text-decoration: none;
                                                            outline: none;
                                                            color: #126de5;
                                                        ">
                                                    <img src="{{ URL::to('/assets/mails/logo-primary.png') }}"
                                                        width="100" height="26" alt="{{ config('app.name') }}"
                                                        style="
                                                                max-width: 100px;
                                                        ...
                                                        <td class="o_btn-b o_heading o_text-xs" align="center"
                                                            style="
                                                                    ...
                                                                    mso-padding-alt: 7px
                                                                        8px;
                                                                ">
                                                            <a class="o_text-light" href="{{ env('APP_FRONTEND_URL') }}"
                                                                style="
                                                                        text-decoration: none;
                                                                        outline: none;
                                                                        color: #82899a;
                                                                ...
                                                                <span
                                                                    style="
                                                                            ...
                                                                            color: #82899a;
                                                                        ">{{ $data['email'] }}</span>
                                                                <img src="{{ URL::to('/assets/mails/person-24-light.png') }}"
                                            ...
                                            <tr>
                                                ...
                                                <td rowspan="2" class="o_sans o_text o_text-secondary o_px o_py"
                                                    ...
                                                    style="
                                                            ...
                                                            padding-bottom: 16px;
                                                        ">
                                                    <img src="{{ URL::to('/assets/mails/vpn_key-48-primary.png') }}"
                                ...
                                <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center"
                                    ...
                                    <p
                                        style="
                                                ...
                                                margin-bottom: 0px;
                                            ">
                                        If you didn’t request this email, you can safely ignore it. Your password won’t
                                        be changed.</p>
                                </td>
                            </tr>
                        </tbody>
                                        ...
                                        <div class="o_px-xs o_sans o_text-xs o_text-light o_left o_xs-center"
                                            ...
                                            <p
                                                style="
                                                        ...
                                                        margin-bottom: 0px;
                                                    ">
                                                <a class="o_text-light o_underline"
                                                    href="{{ env('APP_FRONT_END_URL') }}"
                                                    style="
                                        ...
                                        <div class="o_px-xs o_sans o_text-xs o_text-light o_right o_xs-center"
                                            ...
                                            <p
                                                style="
                                                        ...
                                                        margin-bottom: 0px;
                                                    ">
                                                <a class="o_text-light" href="{{ env('APP_FRONT_END_URL') }}"
                                                    style="
                                                            text-decoration: none;
                                                            outline: none;
                                                            color: #82899a;
                                                        ">
                                                    <img src="{{ URL::to('/assets/mails/facebook-light.png') }}"
                                                ...
                                                <a class="o_text-light" href="{{ env('APP_FRONT_END_URL') }}"
                                                    style="
                                                            ...
                                                            color: #82899a;
                                                        ">
                                                    <img src="{{ URL::to('/assets/mails/twitter-light.png') }}"
                                                ...
                                                <a class="o_text-light" href="{{ env('APP_FRONT_END_URL') }}"
                                                    style="
                                                            ...
                                                            color: #82899a;
                                                        ">
                                                    <img src="{{ URL::to('/assets/mails/instagram-light.png') }}"
